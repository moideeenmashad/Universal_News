...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: 2, navItem: 'Business', LinkTo: ROUTES.BUSINESS },
  { id: 3, navItem: 'Entertainment', LinkTo: ROUTES.ENTERTAINMENT },
  { id: 4, navItem: 'General', LinkTo: ROUTES.GENERAL },
  { id: 5, navItem: 'Health', LinkTo: ROUTES.HEALTH },
        ...
        >
          ...
          <defs>
            <clipPath id="clip0_3_26">
              <rect width="343" height="82" fill="white" transform="translate(0.5)" />
            </clipPath>
          </defs>
        </svg>

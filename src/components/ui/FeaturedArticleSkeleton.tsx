...
export const FeaturedArticleSkeleton = ({ className = '' }: FeaturedArticleSkeletonProps) => {
  return (
    <div className={`animate-pulse ${className} [&_div]:skeleton-shimmer [&_div]:rounded`} aria-hidden="true" role="presentation">
      {/* Image Skeleton */}
      <div className="relative mb-6 overflow-hidden rounded-sm">
        <div className="h-[280px] sm:h-[320px] md:h-[420px] lg:h-[560px] w-full relative">
      ...
      <div className="flex items-center justify-between gap-4 mb-4">
        <div className="flex flex-wrap items-center gap-2">
          <div className="h-6 w-20 rounded-sm"></div>
          <div className="h-6 w-24 rounded-sm"></div>
        </div>

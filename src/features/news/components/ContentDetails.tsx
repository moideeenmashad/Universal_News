...
import { 
  useArticleByTitle, 
  useArticleByTitleUniversal, 
  useLatestNews, 
  useTopHeadlines 
} from '@/features/news/hooks/useNews';
import { formatDate, getPlaceholderImage, slugify, isValidArticle } from '@/shared/utils';
import type { NewsArticle, NewsDataArticle, ContentDetailsProps, UnifiedContent } from '@/shared/types';
import { ArticleDetailSkeleton, ErrorMessage } from '@/shared/components';
import { SimilarNews } from './SimilarNews';
import { useArticleStore } from '@/shared/lib/store/articleStore';

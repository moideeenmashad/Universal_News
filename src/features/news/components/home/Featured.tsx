...
import { useTopHeadlines } from '@/features/news/hooks/useNews';
import { useIntersectionObserver } from '@/shared/hooks';
import { isValidArticle, getPlaceholderImage } from '@/shared/utils';
import { ErrorMessage } from '@/shared/components/ErrorMessage';
import type { FeaturedItem } from '@/shared/types';
...
export const Featured = memo(() => {
  ...
  const worldNewsData = useTopHeadlines(undefined, 'us', 5, isVisible);
